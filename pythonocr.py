...
Internal functions:
    ...
    _get_word_coordinates_from_data(): Retrieves the data of found instances of a word and their 
                                       coordinates from image data.
...
def click_word(word, save_screenshot_as=""):
    ...
    If able to find a single instance of the word, retrieves it's
    coordinates and clicks the location with mouse, using pyautogui. Unable to click the word's location if
    multiple instances of the word are found on screen!
